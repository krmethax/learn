...
app.layout = html.Div([
    html.H1('Dash tab component demo', style={'text-align': 'center'}),
    ...
    html.Div([
        dcc.Tabs(id='tabs-example', value='tab-1', children=[
            dcc.Tab(label='Table', value='tab-1', children=[
                html.Div([
                    ...
                    style={
                        ...
                        'text-align': 'center'  # Collapse borders
                    })
                ],
                style={
            ...
            dcc.Tab(label='Current Graph', value='tab-2', children=[
                html.Div([
            ...
            dcc.Tab(label='Blank Page', value='tab-3', children=[
                html.Div([
                    html.H4('This is a blank page')
                ])
            ]),
        ]),
    ], style={'width': '100%'})  # Adjust width and center tabs horizontally
])
...
def update_scatter_plot(selected_days, y_dims):
    ...
    fig = px.scatter(filtered_df, x='Temperature', y=y_dims[0], color='Play',
                     title=f"Temperature vs {y_dims[0]}",
